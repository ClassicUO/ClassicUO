...
namespace ClassicUO.Game.Gumps.UIGumps
{
    internal class LogoutGump : Gump
    {
        ...
        public LogoutGump() : base(0, 0)
        {
            ...
            AddChildren(new Label("Quit\nUltima Online?", false, 0x0386, 165) {X = 33, Y = 30});
            AddChildren(new Button((int) Buttons.Cancel, 0x817, 0x818) {X = 37, Y = 75, ButtonAction = ButtonAction.Activate});
            AddChildren(new Button((int) Buttons.Ok, 0x81A, 0x81B) {X = 100, Y = 75, ButtonAction = ButtonAction.Activate});
