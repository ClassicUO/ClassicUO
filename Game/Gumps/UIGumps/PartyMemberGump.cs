...
namespace ClassicUO.Game.Gumps.UIGumps
{
    class PartyMemberGump : Gump
    {
        ...
        private void PartyMemberGump_MouseDown(object sender, Input.MouseEventArgs e)
        {
        ...
        public override void Update(double totalMS, double frameMS)
        {
            ...
            if (_partyMember.Mobile != null)
            {
                ...
                _healthLabel.Text = concatLabel(_partyMember.Mobile.Hits.ToString(), 
                    _partyMember.Mobile.HitsMax.ToString());
                _staminaLabel.Text = concatLabel(_partyMember.Mobile.Stamina.ToString(),
                    _partyMember.Mobile.StaminaMax.ToString());
                _manaLabel.Text = concatLabel(_partyMember.Mobile.Mana.ToString(),
                    _partyMember.Mobile.ManaMax.ToString());
            ...
            switch ((Buttons)buttonID)
            {
                ...
                case Buttons.Pin:
                    if (!_isPinned)
                    {
                        ...
                        _isPinned = true;
                        this.CanMove = false;
                        this.CanCloseWithRightClick = false;
                    }
                    else
                    {
                        ...
                        _isPinned = false;
                        this.CanMove = true;
                        this.CanCloseWithRightClick = true;
                    }
                    break;
    ...
    class FrameBorder : GumpControl
    {
        private readonly Texture2D _border;

        public FrameBorder(int x, int y, int w, int h, Color color) : base()
        {
            AcceptMouseInput = true;
            CanMove = true;
            X = x;
