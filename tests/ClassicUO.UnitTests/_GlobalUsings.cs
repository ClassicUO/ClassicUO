...
// Mirror of src/ClassicUO.Client/Game/_GlobalUsings.cs so the test project
// sees manager facades that now live in feature namespaces under
// ClassicUO.Game.<Feature>.
...
global using ClassicUO.Game.Weather;
