    ...
    internal class HealthBarGump : AnchorableGump
    {
        ...
        private void BuildGump()
        {
            ...
            if (World.Party.Contains(LocalSerial))
            {
                ...
                {
                    Add(_textBox = new TextBox(3, width: 109, isunicode: false, style: FontStyle.Fixed | FontStyle.Fixed, hue: Notoriety.GetHue(mobile?.NotorietyFlag ?? NotorietyFlag.Gray))
                    {
                        X = 0,
                        Y = -2,
                        IsEditable = false,
            ...
            else
            {
                if (CanBeSaved)
                {
                    ...
                    Alpha = _background.Alpha = 0.3F;//transparency amount for own healthbar
                    IsTransparent = true;
                ...
                else
                {
                    ...
                    Width = _background.Texture.Width;
                    Height = _background.Texture.Height;
                    Alpha = _background.Alpha = 0.3F;//transparency amount for mobile healthbars
                    IsTransparent = true;
