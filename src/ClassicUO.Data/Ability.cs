...
namespace ClassicUO.Game.Data
{
    ...
    public readonly record struct AbilityDefinition(int Index, string Name, ushort Icon);

    public readonly record struct ItemAbilities(ushort Graphic, Ability First, Ability Second)
    {
