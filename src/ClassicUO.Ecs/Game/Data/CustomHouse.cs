...
// House-customization object tables, parsed from the UO data .txt files
// (walls.txt, floors.txt, doors.txt, misc.txt, stairs.txt, teleprts.txt,
// roof.txt, suppinfo.txt). Ported verbatim from the legacy client
// (Game/Data/CustomHouse.cs) — it is the source of truth for the design-tool
// graphic layout and placement-support rules.
...
// Editor UI/render states mirroring the legacy CUSTOM_HOUSE_* enums.
...
// A single tile to add as part of a build action (legacy CustomBuildObject).
