...
// Port of main's Game/Data/CharacterCreationValues.cs, decoupled from
// Client.Game: combo content returns cliloc ids + graphics, the caller
// resolves labels through its own ClilocLoader.

namespace ClassicUO.Game.Data
{
    internal static class CharacterCreationValues
    {
        ...
        public static ushort[] GetSkinPallet(RaceType race) => race switch
        {
        ...
        public static ushort[] GetHairPallet(RaceType race) => race switch
        {
        ...
        public static (int[] LabelClilocs, int[] Graphics) GetHairComboContent(bool isFemale, RaceType race) => race switch
        {
            RaceType.HUMAN when isFemale => (HumanFemaleHairLabels, HumanFemaleHairGraphics),
            RaceType.HUMAN => (HumanHairLabels, HumanHairGraphics),
            RaceType.ELF when isFemale => (ElfFemaleHairLabels, ElfFemaleHairGraphics),
            RaceType.ELF => (ElfHairLabels, ElfHairGraphics),
            RaceType.GARGOYLE when isFemale => (GargoyleFemaleHairLabels, GargoyleFemaleHairGraphics),
            RaceType.GARGOYLE => (GargoyleHairLabels, GargoyleHairGraphics),
            _ => (System.Array.Empty<int>(), System.Array.Empty<int>()),
        };

        public static (int[] LabelClilocs, int[] Graphics) GetFacialHairComboContent(RaceType race) => race switch
        {
            RaceType.HUMAN => (HumanFacialLabels, HumanFacialGraphics),
            RaceType.GARGOYLE => (GargoyleFacialLabels, GargoyleFacialGraphics),
            _ => (System.Array.Empty<int>(), System.Array.Empty<int>()),
        };
    }
}
