...
//
// Ported verbatim from ClassicUO.Client/Game/Data/Ability.cs for the ECS
// combat book. Weapon-graphic -> primary/secondary special-move map + the
// ability name/icon table the book renders.
