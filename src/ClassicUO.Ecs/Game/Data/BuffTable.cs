...
namespace ClassicUO.Game.Data
{
    ...
    // Maps a buff's table index (BuffIconType offset from the 0x3E9 / 0x466
    // bases) to the gump graphic the BuffGump draws. Ported verbatim from the
    // legacy client's BuffTable._defaultTable; the ECS path has no buff.txt
    // override, so the default table is the table.
    internal static class BuffTable
    {
        public static ushort[] Table => _defaultTable;
