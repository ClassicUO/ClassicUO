...
internal struct OnGraphicEffectPacket_0x70 : IPacket
{
    public byte Id => 0x70;

    public GraphicEffectType EffectType { get; private set; }
    public ulong UnknownHeader { get; private set; }
    public ushort UnknownValue { get; private set; }
    ...
    public void Fill(StackDataReader reader)
    {
        ...
        UnknownHeader = reader.ReadUInt64BE();
        UnknownValue = reader.ReadUInt16BE();
