...
namespace ClassicUO.Game.GameObjects
{
    internal sealed partial class LightningEffect
    {
        public override bool Draw(UltimaBatcher2D batcher, int posX, int posY, float depth)
        {
            ...
            else if ((Client.Game?.UO?.EcsRuntime is { } ecsLe && ecsLe.GetCutoverFlags().UseEcsUiData ? ecsLe.GetPlayerSnapshot().IsDead : World.Player.IsDead) && ProfileManager.CurrentProfile.EnableBlackWhiteEffect)
            {
