...
{
    internal sealed class UIManagerInstance : IUIManager
    {
        ...
        public UIManagerInstance(IGameController game, IProfileProvider profileProvider)
        {
            _game = game;
        ...
        public bool IsMouseOverWorld
        {
            get
            {
                ...
                Profile profile = _profileProvider.CurrentProfile;

                return profile != null &&
                    _game.UO.GameCursor.AllowDrawSDLCursor &&
                    DraggingControl == null &&
                    MouseOverControl == null &&
                    !IsModalOpen &&
                    _game.Scene.Camera.Bounds.Contains(mouse);
            }
        }
        ...
        public void OnMouseDragging()
        {
            ...
            {
                if (_profileProvider.CurrentProfile == null || !_profileProvider.CurrentProfile.HoldAltToMoveGumps || Keyboard.Alt)
                {
        ...
        public void OnMouseButtonUp(MouseButtonType button)
        {
            ...
            if (MouseOverControl != null)
            {
                if (_mouseDownControls[index] != null && MouseOverControl == _mouseDownControls[index] || _game.UO.GameCursor.ItemHold.Enabled)
                {
        ...
        public bool OnMouseDoubleClick(MouseButtonType button)
        {
            ...
            if (MouseOverControl != null)
            {
                if (MouseOverControl.InvokeMouseDoubleClick(Mouse.Position, button))
                {
                    ...
                    {
                        _game.UO.World.DelayedObjectClickManager.Clear();
                    }
        ...
        public IEnumerable<Control> GetAllMouseOverControlsOfType<T>() where T : Control
        {
        ...
        {
            if ((_isDraggingControl && !attemptAlwaysSuccessful) || _game.UO.GameCursor.ItemHold.Enabled && !_game.UO.GameCursor.ItemHold.IsFixedPosition)
            {
                return;
            }
