...
namespace ClassicUO.Game.Data
{
    public static class Mounts
    {
        ...
        public static (ushort, sbyte) FixMountGraphic(TileDataLoader tileData, ushort graphic)
        {
            var originalGraphic = graphic;
            if (_mounts.TryGetValue(graphic, out var mountInfo))
            {
            ...
            {
                return (graphic, mountInfo.OffsetY);
            }
