...
namespace ClassicUO.Game.UI.Controls
{
    ...
    internal class Button : Control
    {
        ...
        )
        {
            ...
            ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(normal);
        ...
        public ushort ButtonGraphicNormal
        {
            ...
            set
            {
                ...
                ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(value);
        ...
        public override bool Draw(UltimaBatcher2D batcher, int x, int y)
        {
            ...
            if (_entered || IsClicked)
            {
                ...
                {
                    ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(_pressed);
                ...
                {
                    ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(_over);
                    texture = gumpInfo.Texture;
                    bounds = gumpInfo.UV;
                }
            }
            ...
            if (texture == null)
            {
                ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(_normal);
                texture = gumpInfo.Texture;
                bounds = gumpInfo.UV;
            }
        ...
        public override bool Contains(int x, int y)
        {
            ...
            return ContainsByBounds
                ? base.Contains(x, y)
                : ServiceProvider.Get<UOService>().Gumps.PixelCheck(_normal, x - Offset.X, y - Offset.Y);
        }
