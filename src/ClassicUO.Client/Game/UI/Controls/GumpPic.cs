...
namespace ClassicUO.Game.UI.Controls
{
    internal abstract class GumpPicBase : Control
    {
        ...
        public ushort Graphic
        {
            ...
            set
            {
                ...
                ref readonly var gumpInfo = ref ServiceProvider.Get<UOService>().Gumps.GetGump(_graphic);
        ...
        public override bool Contains(int x, int y)
        {
            ...
            if (ServiceProvider.Get<UOService>().Gumps.PixelCheck(Graphic, x - Offset.X, y - Offset.Y))
            {
                return true;
            }
    ...
    internal class VirtueGumpPic : GumpPic
    {
        ...
        protected override bool OnMouseDoubleClick(int x, int y, MouseButtonType button)
        {
            ...
            {
                ServiceProvider.Get<PacketHandlerService>().Out.Send_VirtueGumpResponse(_world.Player, Graphic);
