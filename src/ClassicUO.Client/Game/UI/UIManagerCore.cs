...
{
    /// <summary>
    ///     Instance-backed implementation of the UI manager state and logic.
    ///     The static <see cref="UIManager"/> class is a thin facade that
    ///     delegates each member to a single <see cref="UIManagerCore"/>
    ///     instance, providing a DI seam without changing existing call sites.
    /// </summary>
    internal sealed class UIManagerCore
    {
