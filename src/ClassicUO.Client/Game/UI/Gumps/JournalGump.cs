...
namespace ClassicUO.Game.UI.Gumps
{
    internal class JournalGump : Gump
    {
        ...
        public JournalGump(World world) : base(world, 0, 0)
        {
            ...
            int width = assetsService.Fonts.GetWidthASCII(6, str);
        ...
        private void AddJournalEntry(object sender, JournalEntry entry)
        {
            ...
            if (!string.IsNullOrEmpty(usrSend) && ServiceProvider.Get<ManagersService>().IgnoreManager.IgnoredCharsList.Contains(usrSend))
                return;
