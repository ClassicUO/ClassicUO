    ...
    internal class ModernOptionsGump : Gump
    {
        ...
        private void BuildTazUO()
        {
            ...
            */
            ...
            c.MouseUp += (s, e) =>
            {
                ...
                {
                    UIManager.Add(new InputRequest(_world, lang.GetTazUO.InputRequestUrl, lang.GetTazUO.Download, lang.GetTazUO.Cancel, (r, s) =>
                    {
            ...
            c.MouseUp += (s, e) => { UIManager.GetGump<ToolTipOverideMenu>()?.Dispose(); UIManager.Add(new ToolTipOverideMenu(_world)); };
        ...
        public Control GenConditionControl(int key, int width, bool createIfNotExists)
        {
            ...
            _preview.MouseUp += (s, e) =>
            {
                ...
                {
                    CoolDownBarManager.AddCoolDownBar(_world, TimeSpan.FromSeconds(value), _name.Text, _hueSelector.Hue, _replaceIfExists.IsChecked);
                }
            };
            main.Add(_preview);
        ...
        private class MacroControl : Control
        {
            ...
            private void OpenMacroButtonEditor(Macro macro, Vector2? position = null)
            {
                ...
                if (btnEditorGump == null)
                {
                    ...
                    btnEditorGump = new MacroButtonEditorGump(_world, macro, posX, posY);
        ...
        public class ThemeSettings : UISettings
        {
