...
namespace ClassicUO.Game.UI.Gumps
{
    internal class SimpleTimedTextGump : Gump
    {
        ...
        public SimpleTimedTextGump(string text, Color color, TimeSpan duration) : base(world, 0, 0)
        {
        ...
        public SimpleTimedTextGump(string text, uint hue, TimeSpan duration) : base(world, 0, 0)
        {
            expireAt = DateTime.Now.Add(duration);
        ...
        public SimpleTimedTextGump(string text, uint hue, TimeSpan duration, int width) : base(world, 0, 0)
        {
            expireAt = DateTime.Now.Add(duration);
