...
namespace ClassicUO.Game
{
    public sealed class UltimaLive
    {
        ...
        public static void Enable()
        {
            ...
            packetHandlerService.AddHandler(0x3F, OnUltimaLivePacket);
            packetHandlerService.AddHandler(0x40, OnUpdateTerrainPacket);
        }
        ...
        private static void OnUltimaLivePacket(ref StackDataReader p)
        {
            ...
            switch (command)
            {
                case 0xFF: //hash query, for the blocks around us
                {
                    ...
                    ServiceProvider.Get<PacketHandlerService>().Out.Send_UOLive_HashResponse((uint) block, (byte) mapId, checkSumsToBeSent.AsSpan(0, CRC_LENGTH));
