...
namespace ClassicUO.Network
{
    public sealed class NetStatistics
    {
        ...
        /// <summary>
        /// Callback to send a ping packet. Set by the host application
        /// to wire up the outgoing ping packet without depending on game-layer extension methods.
        /// </summary>
        public Action<INetworkClient, byte> SendPingAction { get; set; }
        ...
        {
            _pings[idx % _pings.Length] = Ticks - _startTickValue;
        }
        ...
        public void SendPing()
        {
            ...
            _startTickValue = Ticks;
            SendPingAction?.Invoke(_socket, _pingIdx);
        ...
        public void Update()
        {
            if (_statisticsTimer > Ticks) return;

            _statisticsTimer = Ticks + 500;
        ...
        private static uint Ticks => (uint)Environment.TickCount;
    }
}
