...
namespace ClassicUO.Sdk.Assets
{
    public sealed class FontsLoader : UOFileLoader
    {
        ...
        )
        {
            ...
            var info = GetInfoASCII(font, text, text.Length, align, flags, maxwidth);
        ...
        public struct FontInfo
        {
            ...
            public static readonly FontInfo Empty = new FontInfo() { Data = Array.Empty<uint>() };
        }
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    datacolor = ColorConverter.RgbaToArgb(
                    ...
                    for (int i = 0; i < dataSize; i++)
                    {
                        ...
                        if (si != ' ')
                        {
                            if (IsUsingHTML && i < ptr.Data.Count)
                            {
                                ...
                                {
                                    charcolor = ColorConverter.RgbaToArgb(dataPtr.Color);
                ...
                )
                {
                    ...
                    uint hue = ColorConverter.RgbaToArgb(_htmlStatus.BackgroundColor);
        ...
        )
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                if (si == '<')
                {
                    ...
                    GetCurrentHTMLInfo(stack, ref currentInfo);
        ...
        private void GetCurrentHTMLInfo(List<HTMLDataInfo> list, ref HTMLDataInfo info)
        {
        ...
        )
        {
            ...
            if (j != i && i < len)
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("Unhandled HTML param: {0}", str.ToString());
                    }
                }
        ...
        private ushort GetWebLinkID(ReadOnlySpan<char> link, ref uint color)
        {
            ...
            if (!_webLinks.TryGetValue(linkID, out var webLink))
            {
                webLink = new WebLink();
