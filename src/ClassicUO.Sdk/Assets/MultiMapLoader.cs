    ...
    public sealed class MultiMapLoader : UOFileLoader
    {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    colorOffset -= 31;
                    colorTable[i] = ColorConverter.Color16To32(huesData[colorOffset / maxPixelValue]) | 0xFF_00_00_00;
                }
        ...
        )
        {
            ...
            for (int y = 0; y < h; y++)
            {
                ...
                for (int i = 0; i < colorCount; i++)
                {
                    ...
                    uint color = ColorConverter.Color16To32(file.ReadUInt16()) | 0xFF_00_00_00;
