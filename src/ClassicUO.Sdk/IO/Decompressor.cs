...
{
    public static unsafe void Zlib(ReadOnlySpan<byte> data, Span<byte> decompressedData)
    {
    ...
    public static byte[] Bwt(byte[] buffer)
    {
        return BwtDecompress.Decompress(buffer);
    }

    private static class BwtDecompress
    {
