...
namespace ClassicUO.Sdk
{
    public sealed class UOFileManager : IDisposable
    {
        ...
        public UOFileManager(ClientVersion clientVersion, string uoPath, string mapsLayout)
        {
            ...
            Maps = new MapLoader(this, mapsLayout);
        ...
        public string GetUOFilePath(string file)
        {
            ...
            if (!isWindows && !File.Exists(uoFilePath))
            {
        ...
        public void Load(bool useVerdata, string lang)
        {
