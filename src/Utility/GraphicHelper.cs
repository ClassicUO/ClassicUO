...
namespace ClassicUO.Utility
{
    class GraphicHelper
    {
        ...
        /// <param name="partXYplusWidthHeight">We must specify here an array with size of 'parts' for the first dimension, 
        /// for each part, in the second dimension, we specify:
        /// starting x and y, plus width and height for that specified part (4 as size in second dimension).</param>
        internal static SpriteTexture[] SplitTexture16(SpriteTexture original, int[,] partXYplusWidthHeight)
        {
            ...
            original.GetData<ushort>(originalData, 0, pwidth * pheight);
