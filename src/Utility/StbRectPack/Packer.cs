...
namespace StbRectPackSharp
{
	...
	unsafe class Packer : IDisposable
	{
		...
		/// <returns></returns>
		public bool PackRect(int width, int height, object userData, out PackerRectangle packRectangle)
		{
			...
			packRectangle = new PackerRectangle(new Rectangle(rect.x, rect.y, rect.w, rect.h), userData);
