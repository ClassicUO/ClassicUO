                ...
                switch (obj)
                {
                    ...
                    default:
                        ...
                        if (GameObjectHelper.TryGetStaticData(obj, out itemData))
                        {
                            ...
                            if (((Engine.Profile.Current.TreeToStumps && itemData.IsFoliage) || (Engine.Profile.Current.HideVegetation && StaticFilters.IsVegetation(obj.Graphic))) && !itemData.IsImpassable)
                                continue;
