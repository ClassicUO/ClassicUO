    ...
    internal class HealthBarGumpCustom : AnchorableGump
    {
        ...
        public override void Update(double totalMS, double frameMS)
        {
            ...
            if (entity != null && !entity.IsDestroyed)
            {
                ...
                int barW = inparty ? Engine.Profile.Current.CustomBarsToggled ? 100 : 96 : 109; //works for 100 hp and strengthed to 120 hp
        ...
        private void BuildCustomGump()
        {
            ...
            var entity = World.Get(LocalSerial);
            int namewidth = FileManager.Fonts.GetWidthUnicode(_renderedText.Font, _name); //rendered text
            ...
            if (World.Party.Contains(LocalSerial))
            {
                ...
                Add(_bars[0] = new GumpPicWithWidth(6, 27, LINE_BLUE, 0, 96));
                Add(_bars[1] = new GumpPicWithWidth(6, 36, LINE_BLUE, 0, 96));
                Add(_bars[2] = new GumpPicWithWidth(6, 45, LINE_BLUE, 0, 96));
            }
            else
            {
                if (CanBeSaved)
