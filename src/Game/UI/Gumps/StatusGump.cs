...
namespace ClassicUO.Game.UI.Gumps
{
    internal abstract class StatusGumpBase : Gump
    {
        ...
        {
            // sanity check
            UIManager.GetGump<HealthBarGump>(World.Player)
                     ?.Dispose();
        ...
        protected override void OnMouseUp(int x, int y, MouseButtonType button)
        {
            if (button == MouseButtonType.Left)
            {
                ...
                else if (x >= _point.X && x <= Width + 16 && y >= _point.Y && y <= Height + 16)
                {
                    ...
                    {
                        UIManager.GetGump<BaseHealthBarGump>(World.Player)
                                 ?.Dispose();
        ...
        protected override void UpdateContents()
        {
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    _lockers[i]
                        .Graphic = GetStatLockGraphic(status);
                }
            }
        }
    ...
    internal class StatusGumpOld : StatusGumpBase
    {
        public StatusGumpOld()
        {
            ...
            Add(new HitBox(86, 61, 34, 12, ResGumps.Strength, 1) {CanMove = true});
            Add(new HitBox(86, 73, 34, 12, ResGumps.Dex, 1) {CanMove = true});
            Add(new HitBox(86, 85, 34, 12, ResGumps.Intelligence, 1) {CanMove = true});
            Add(new HitBox(86, 97, 34, 12, ResGumps.Sex, 1) {CanMove = true});
            Add(new HitBox(86, 109, 34, 12, ResGumps.Armor, 1) {CanMove = true});
            Add(new HitBox(171, 61, 66, 12, ResGeneral.Hits, 1) {CanMove = true});
            Add(new HitBox(171, 73, 66, 12, ResGeneral.Mana, 1) {CanMove = true});
            Add(new HitBox(171, 85, 66, 12, ResGumps.Stamina, 1) {CanMove = true});
            Add(new HitBox(171, 97, 66, 12, ResGumps.Gold, 1) {CanMove = true});
            Add(new HitBox(171, 109, 66, 12, ResGeneral.Weight, 1) {CanMove = true});
        ...
        public override void Update(double totalMS, double frameMS)
        {
            ...
            if (_refreshTime < totalMS)
            {
                ...
                _labels[(int) MobileStats.Name]
                    .Text = !string.IsNullOrEmpty(World.Player.Name) ? World.Player.Name : string.Empty;

                _labels[(int) MobileStats.Strength]
                    .Text = World.Player.Strength.ToString();

                _labels[(int) MobileStats.Dexterity]
                    .Text = World.Player.Dexterity.ToString();

                _labels[(int) MobileStats.Intelligence]
                    .Text = World.Player.Intelligence.ToString();

                _labels[(int) MobileStats.Sex]
                    .Text = World.Player.IsFemale ? ResGumps.Female : ResGumps.Male;

                _labels[(int) MobileStats.AR]
                    .Text = World.Player.PhysicalResistance.ToString();

                _labels[(int) MobileStats.HealthCurrent]
                    .Text = $"{World.Player.Hits}/{World.Player.HitsMax}";

                _labels[(int) MobileStats.ManaCurrent]
                    .Text = $"{World.Player.Mana}/{World.Player.ManaMax}";

                _labels[(int) MobileStats.StaminaCurrent]
                    .Text = $"{World.Player.Stamina}/{World.Player.StaminaMax}";

                _labels[(int) MobileStats.Gold]
                    .Text = World.Player.Gold.ToString();

                _labels[(int) MobileStats.WeightCurrent]
                    .Text = World.Player.Weight.ToString();
            }
    ...
    internal class StatusGumpModern : StatusGumpBase
    {
        public StatusGumpModern()
        {
            ...
            if (Client.Version >= ClientVersion.CV_308Z)
            {
                ...
                if (Client.UseUOPGumps)
                {
                    ...
                    Add(new HitBox(58, 154, 59, 24, ResGumps.HitChanceIncrease, 1) {CanMove = true});
                }
                else
                {
                    xOffset = 88;
                ...
                Add(new HitBox(58, 70, 59, 24, ResGumps.Strength, 1) {CanMove = true});
                Add(new HitBox(58, 98, 59, 24, ResGumps.Dexterity, 1) {CanMove = true});
                Add(new HitBox(58, 126, 59, 24, ResGumps.Intelligence, 1) {CanMove = true});
                ...
                if (Client.UseUOPGumps)
                {
                    ...
                    Add(new HitBox(124, 154, 59, 24, ResGumps.DefenseChanceIncrease, 1) {CanMove = true});
                }
                else
                {
                    xOffset = 146;
                ...
                Add(new HitBox(124, 70, 59, 24, ResGumps.HitPoints, 1) {CanMove = true});
                Add(new HitBox(124, 98, 59, 24, ResGumps.Stamina, 1) {CanMove = true});
                Add(new HitBox(124, 126, 59, 24, ResGeneral.Mana, 1) {CanMove = true});
                ...
                if (Client.UseUOPGumps)
                {
                    ...
                    Add(new HitBox(205, 154, 65, 24, ResGumps.LowerManaCost, 1) {CanMove = true});
                }
                else
                {
                    xOffset = 220;
                ...
                Add(new HitBox(xOffset, 70, 65, 24, ResGumps.MaximumStats, 1) {CanMove = true});
                Add(new HitBox(xOffset, 98, 65, 24, ResGumps.Luck, 1) {CanMove = true});
                Add(new HitBox(xOffset, 126, 65, 24, ResGeneral.Weight, 1) {CanMove = true});
                ...
                if (Client.UseUOPGumps)
                {
                    ...
                    Add(new HitBox(285, 98, 69, 24, ResGumps.WeaponDamageIncrease, 1) {CanMove = true});
                    Add(new HitBox(285, 154, 69, 24, ResGumps.SwingSpeedIncrease, 1) {CanMove = true});
                }
                else
                {
                    xOffset = 280;
                    ...
                    Add(new HitBox(260, 98, 69, 24, ResGumps.Gold, 1) {CanMove = true});
                }
                ...
                Add(new HitBox(xOffset, 70, 69, 24, ResGumps.Damage, 1) {CanMove = true});
                Add(new HitBox(xOffset, 126, 69, 24, ResGumps.Followers, 1) {CanMove = true});
                ...
                if (Client.UseUOPGumps)
                {
                    ...
                    Add(new HitBox(xOffset, 70, 55, 24, ResGumps.LowerReagentCost, 1) {CanMove = true});
                    Add(new HitBox(xOffset, 98, 55, 24, ResGumps.SpellDamageIncrease, 1) {CanMove = true});
                    Add(new HitBox(xOffset, 126, 55, 24, ResGumps.FasterCasting, 1) {CanMove = true});
                    Add(new HitBox(xOffset, 154, 55, 24, ResGumps.FasterCastRecovery, 1) {CanMove = true});

                    xOffset = 480;

                    AddStatTextLabel(World.Player.Gold.ToString(), MobileStats.Gold, xOffset, 161);
                    Add(new HitBox(445, 154, 55, 24, ResGumps.Gold, 1) {CanMove = true});
                ...
                Add(new HitBox(xOffset, 76, 40, 14, ResGumps.PhysicalResistance, 1) {CanMove = true});
                Add(new HitBox(xOffset, 92, 40, 14, ResGumps.FireResistance, 1) {CanMove = true});
                Add(new HitBox(xOffset, 106, 40, 14, ResGumps.ColdResistance, 1) {CanMove = true});
                Add(new HitBox(xOffset, 120, 40, 14, ResGumps.PoisonResistance, 1) {CanMove = true});
                Add(new HitBox(xOffset, 134, 40, 14, ResGumps.EnergyResistance, 1) {CanMove = true});
            }
            else
            {
                if (Client.Version == ClientVersion.CV_308D)
                {
                    ...
                    Add(new HitBox(171, 124, 34, 12, ResGumps.MaxStats, 1) {CanMove = true});
                }
                else if (Client.Version == ClientVersion.CV_308J)
                {
                    ...
                    Add(new HitBox(180, 131, 34, 12, ResGumps.MaxStats, 1) {CanMove = true});
                    Add(new HitBox(171, 144, 34, 12, ResGumps.Followers, 1) {CanMove = true});
                }
            }
            ...
            Add(new HitBox(p.X, p.Y, 16, 16, ResGumps.Minimize, 1) {CanMove = true});
        ...
        public override void Update(double totalMS, double frameMS)
        {
            ...
            if (_refreshTime < totalMS)
            {
                ...
                if (Client.UseUOPGumps)
                {
                    _labels[(int) MobileStats.HitChanceInc]
                        .Text = World.Player.HitChanceIncrease.ToString();
                }
                ...
                if (Client.UseUOPGumps)
                {
                    _labels[(int) MobileStats.DefenseChanceInc]
                        .Text = $"{World.Player.DefenseChanceIncrease}/{World.Player.MaxDefenseChanceIncrease}";
                }

                _labels[(int) MobileStats.HealthCurrent]
                    .Text = World.Player.Hits.ToString();

                _labels[(int) MobileStats.HealthMax]
                    .Text = World.Player.HitsMax.ToString();

                _labels[(int) MobileStats.StaminaCurrent]
                    .Text = World.Player.Stamina.ToString();

                _labels[(int) MobileStats.StaminaMax]
                    .Text = World.Player.StaminaMax.ToString();

                _labels[(int) MobileStats.ManaCurrent]
                    .Text = World.Player.Mana.ToString();

                _labels[(int) MobileStats.ManaMax]
                    .Text = World.Player.ManaMax.ToString();

                if (Client.UseUOPGumps)
                {
                    _labels[(int) MobileStats.LowerManaCost]
                        .Text = World.Player.LowerManaCost.ToString();
                }

                _labels[(int) MobileStats.StatCap]
                    .Text = World.Player.StatsCap.ToString();

                _labels[(int) MobileStats.Luck]
                    .Text = World.Player.Luck.ToString();

                _labels[(int) MobileStats.WeightCurrent]
                    .Text = World.Player.Weight.ToString();

                _labels[(int) MobileStats.WeightMax]
                    .Text = World.Player.WeightMax.ToString();

                if (Client.UseUOPGumps)
                {
                    _labels[(int) MobileStats.DamageChanceInc]
                        .Text = World.Player.DamageIncrease.ToString();

                    _labels[(int) MobileStats.SwingSpeedInc]
                        .Text = World.Player.SwingSpeedIncrease.ToString();
                }

                _labels[(int) MobileStats.Gold]
                    .Text = World.Player.Gold.ToString();

                _labels[(int) MobileStats.Damage]
                    .Text = $"{World.Player.DamageMin}-{World.Player.DamageMax}";

                _labels[(int) MobileStats.Followers]
                    .Text = $"{World.Player.Followers}/{World.Player.FollowersMax}";

                if (Client.UseUOPGumps)
                {
                    _labels[(int) MobileStats.LowerReagentCost]
                        .Text = World.Player.LowerReagentCost.ToString();

                    _labels[(int) MobileStats.SpellDamageInc]
                        .Text = World.Player.SpellDamageIncrease.ToString();

                    _labels[(int) MobileStats.FasterCasting]
                        .Text = World.Player.FasterCasting.ToString();

                    _labels[(int) MobileStats.FasterCastRecovery]
                        .Text = World.Player.FasterCastRecovery.ToString();

                    _labels[(int) MobileStats.AR]
                        .Text = $"{World.Player.PhysicalResistance}/{World.Player.MaxPhysicResistence}";

                    _labels[(int) MobileStats.RF]
                        .Text = $"{World.Player.FireResistance}/{World.Player.MaxFireResistence}";

                    _labels[(int) MobileStats.RC]
                        .Text = $"{World.Player.ColdResistance}/{World.Player.MaxColdResistence}";

                    _labels[(int) MobileStats.RP]
                        .Text = $"{World.Player.PoisonResistance}/{World.Player.MaxPoisonResistence}";

                    _labels[(int) MobileStats.RE]
                        .Text = $"{World.Player.EnergyResistance}/{World.Player.MaxEnergyResistence}";
                }
                else
                {
                    _labels[(int) MobileStats.AR]
                    ...
                    _labels[(int) MobileStats.RF]
                        .Text = World.Player.FireResistance.ToString();

                    _labels[(int) MobileStats.RC]
                        .Text = World.Player.ColdResistance.ToString();

                    _labels[(int) MobileStats.RP]
                        .Text = World.Player.PoisonResistance.ToString();

                    _labels[(int) MobileStats.RE]
                        .Text = World.Player.EnergyResistance.ToString();
                }
            }
    ...
    internal class StatusGumpOutlands : StatusGumpBase
    {
        ...
        public StatusGumpOutlands()
        {
            ...
            if (Client.Version >= ClientVersion.CV_5020)
            {
                ...
                Add(new Label(ResGumps.Buffs, false, 0x0386, 60, 1) {X = 174, Y = 40});
            }
            ...
            Add
            (
                _lockers[(int) StatType.Str] = new GumpPic
                (
            ...
            Add
            (
                _lockers[(int) StatType.Dex] = new GumpPic
                (
            ...
            Add
            (
                _lockers[(int) StatType.Int] = new GumpPic
                (
                    10, 130, GetStatLockGraphic(World.Player.IntLock), 0
                )
            );

            _lockers[(int) StatType.Str]
                .MouseUp += (sender, e) =>
            {
                World.Player.StrLock = (Lock) (((byte) World.Player.StrLock + 1) % 3);
                GameActions.ChangeStatLock(0, World.Player.StrLock);
                ...
                _lockers[(int) StatType.Str]
                    .Graphic = GetStatLockGraphic(World.Player.StrLock);
            };

            _lockers[(int) StatType.Dex]
                .MouseUp += (sender, e) =>
            {
                World.Player.DexLock = (Lock) (((byte) World.Player.DexLock + 1) % 3);
                GameActions.ChangeStatLock(1, World.Player.DexLock);
                ...
                _lockers[(int) StatType.Dex]
                    .Graphic = GetStatLockGraphic(World.Player.DexLock);
            };

            _lockers[(int) StatType.Int]
                .MouseUp += (sender, e) =>
            {
                World.Player.IntLock = (Lock) (((byte) World.Player.IntLock + 1) % 3);
                GameActions.ChangeStatLock(2, World.Player.IntLock);
                ...
                _lockers[(int) StatType.Int]
                    .Graphic = GetStatLockGraphic(World.Player.IntLock);
            };
        ...
        public override void Update(double totalMS, double frameMS)
        {
            ...
            if (_refreshTime < totalMS)
            {
                ...
                _labels[(int) MobileStats.HungerSatisfactionMinutes]
                    .Text = World.Player.Luck.ToString(); // FIXME: packet handling

                _labels[(int) MobileStats.MurderCount]
                    .Text = World.Player.StatsCap.ToString(); // FIXME: packet handling

                _labels[(int) MobileStats.MurderCountDecayHours]
                    .Text = World.Player.FireResistance.ToString(); // FIXME: packet handling

                _labels[(int) MobileStats.CriminalTimerSeconds]
                    .Text = World.Player.ColdResistance.ToString(); // FIXME: packet handling

                _labels[(int) MobileStats.PvpCooldownSeconds]
                    .Text = World.Player.PoisonResistance.ToString(); // FIXME: packet handling

                _labels[(int) MobileStats.BandageTimerSeconds]
                    .Text = World.Player.EnergyResistance.ToString(); // FIXME: packet handling
            }
        ...
        private void UpdateStatusFillBar(FillStats id, int current, int max)
        {
            ...
            if (max > 0)
            {
                ...
                _fillBars[(int) id]
                    .Percent = CalculatePercents(max, current, 109);
            }
        }
