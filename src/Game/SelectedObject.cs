...
namespace ClassicUO.Game
{
    internal static class SelectedObject
    {
        ...
        [MethodImpl(256)]
        public static bool IsPointInStatic(SpriteTexture texture, ushort graphic, int x, int y)
        {
            return texture != null && texture.Contains(TranslatedMousePositionByViewport.X - x, TranslatedMousePositionByViewport.Y - y);
        }

        [MethodImpl(256)]
        public static bool IsPointInLand(SpriteTexture texture, ushort graphic, int x, int y)
        {
            return texture != null && texture.Contains(TranslatedMousePositionByViewport.X - x, TranslatedMousePositionByViewport.Y - y);
        }
