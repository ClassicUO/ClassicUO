        ...
        static SpellsMastery()
        {
            _spellsDict = new Dictionary<int, SpellDefinition>
            {
                // Spell List
                {
                    1,
                    new SpellDefinition
                        ("Inspire", 701, 0x945, 0x945, "Uus Por", 16, 90, 4, TargetType.Beneficial, Reagents.None)
                },
                {
                    2,
                    new SpellDefinition
                        ("Invigorate", 702, 0x946, 0x946, "An Zu", 22, 90, 5, TargetType.Beneficial, Reagents.None)
                },
                {
                    3,
                    new SpellDefinition
                    (
                        "Resilience", 703, 0x947, 0x947, "Kal Mani Tym", 16, 90, 4, TargetType.Beneficial, Reagents.None
                    )
                },
                {
                    4,
                    new SpellDefinition
                    (
                        "Perseverance", 704, 0x948, 0x948, "Uus Jux Sanct", 18, 90, 5, TargetType.Beneficial,
                        Reagents.None
                    )
                },
                {
                    ...
                    new SpellDefinition
                    (
                        "Tribulation", 705, 0x949, 0x949, "In Jux Hur Rel", 24, 90, 10, TargetType.Harmful,
                        Reagents.None
                    )
                },
                {
                    ...
                    new SpellDefinition
                    (
                        "Despair", 706, 0x94A, 0x94A, "Kal Des Mani Tym", 26, 90, 12, TargetType.Harmful, Reagents.None
                    )
                },
                {
                    7,
                    new SpellDefinition
                    (
                        "Death Ray", 707, 0x9B8B, 0x9B8B, "In Grav Corp", 50, 90, 35, TargetType.Harmful,
                        Reagents.BlackPearl, Reagents.Bloodmoss, Reagents.SpidersSilk
                    )
                },
                {
                    8,
                    new SpellDefinition
                    (
                        "Ethereal Burst", 708, 0x9B8C, 0x9B8C, "Uus Ort Grav", 0, 90, 0, TargetType.Beneficial,
                        Reagents.Bloodmoss, Reagents.Ginseng, Reagents.MandrakeRoot
                    )
                },
                {
                    9,
                    new SpellDefinition
                    (
                        "Nether Blast", 709, 0x9B8D, 0x9B8D, "In Vas Xen Por", 40, 90, 0, TargetType.Harmful,
                        Reagents.DragonsBlood, Reagents.DemonBone
                    )
                },
                {
                    10,
                    new SpellDefinition
                    (
                        "Mystic Weapon", 710, 0x9B8E, 0x9B8E, "Vas Ylem Wis", 40, 90, 0, TargetType.Neutral,
                        Reagents.FertileDirt, Reagents.Bone
                    )
                },
                {
                    11,
                    new SpellDefinition
                    (
                        "Command Undead", 711, 0x9B8F, 0x9B8F, "In Corp Xen Por", 40, 90, 0, TargetType.Neutral,
                        Reagents.DaemonBlood, Reagents.PigIron, Reagents.BatWing
                    )
                },
                {
                    12,
                    new SpellDefinition
                    (
                        "Conduit", 712, 0x9B90, 0x9B90, "Uus Corp Grav", 40, 90, 0, TargetType.Harmful,
                        Reagents.NoxCrystal, Reagents.BatWing, Reagents.GraveDust
                    )
                },
                {
                    13,
                    new SpellDefinition
                        ("Mana Shield", 713, 0x9B91, 0x9B91, "Faerkulggen", 40, 90, 0, TargetType.Beneficial)
                },
                {
                    14,
                    new SpellDefinition
                        ("Summon Reaper", 714, 0x9B92, 0x9B92, "Lartarisstree", 50, 90, 0, TargetType.Neutral)
                },
                {
                    15,
                    new SpellDefinition("Enchanted Summoning", 715, 0x9B93, 0x9B93, "", 0, 90, 0, TargetType.Neutral)
                },
                {
