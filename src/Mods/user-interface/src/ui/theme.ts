...
export function color(r: number, g: number, b: number, a: number = 1): ClayColor {
  return { r, g, b, a };
}

export function sizing(type: SizingType, value?: number, min?: number, max?: number): ClaySizing {
