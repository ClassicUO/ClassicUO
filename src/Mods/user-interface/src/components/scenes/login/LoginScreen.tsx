...
import { FloatingAttachToElement, FloatingClipToElement, LayoutAlignment, LayoutDirection, SizingType } from '~/host';
import { Button, Checkbox, Gump, HSliderBar, Text, TextInput } from '~/react';
...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onQuit, onCredits, onLogin }) => {
