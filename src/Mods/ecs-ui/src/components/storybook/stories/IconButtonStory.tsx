  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <IconButton icon={{ type: 'gump', id: 0x15a4 }} onClick={handleClick} />
        </ComponentShowcase>
        ...
        >
          <IconButton icon={{ type: 'art', id: 0x15a4 }} onClick={handleClick} />
        </ComponentShowcase>
        ...
        <ComponentShowcase name="Disabled State" description="Button in disabled state" code="disabled={true}">
          <IconButton
            icon={{ type: 'gump', id: 0x15a4 }}            disabled={true}
            onClick={handleClick}
          />
        </ComponentShowcase>
      </View>
      ...
      >
        ...
        >
          <IconButton
            icon={{ type: 'gump', id: 0x15a4 }}            iconOffset={{ x: 50, y: 50 }}
            onClick={handleClick}
          />
        </ComponentShowcase>
        ...
        <ComponentShowcase name="Custom Hue" description="Button with custom color hue" code="color={{ hue: 0x44 }}">
          <IconButton
            icon={{ type: 'gump', id: 0x15a4 }}            color={{ hue: 0x44 }}
            onClick={handleClick}
          />
        </ComponentShowcase>
